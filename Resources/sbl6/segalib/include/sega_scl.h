...
typedef struct SclVramConfig{
	Uint32	ktboffsetA;/* ���]���Ұ�A�p�W��ð��ق���ݸ���̂ǂ��ɔz�u���邩 */
	Uint32	ktboffsetB;/* ���]���Ұ�B�p�W��ð��ق���ݸ���̂ǂ��ɔz�u���邩 */
	Uint8	vramModeA; /* VRAM A ���Q�̃o���N�ɋ��؂邩�w��(0/1)  */
	Uint8	vramModeB; /* VRAM B ���Q�̃o���N�ɋ��؂邩�w��(0/1)  */
	Uint8	vramA0;    /* VRAM A or A0 �����]�ʂ̉��Ŏg�p���邩�w�� */
	Uint8	vramA1;    /* VRAM A1 �����]�ʂ̉��Ŏg�p���邩�w��      */
	Uint8	vramB0;    /* VRAM B or B0 �����]�ʂ̉��Ŏg�p���邩�w�� */
	Uint8	vramB1;    /* VRAM B1 �����]�ʂ̉��Ŏg�p���邩�w��      */
	Uint8	colram;    /* �J���[�q�`�l�ɌW���f�[�^���u�����H        */
} SclVramConfig;
...
#define SCL_NON			0   /* RBG0�ł͎g�p���Ȃ�        */
#define SCL_RBG0_K 		1   /* RBG0�̌W��ð��ق��u��     */
#define SCL_RBG0_PN 		2   /* RBG0�������Ȱ�ð��ق��u�� */
#define SCL_RBG0_CHAR 		3   /* RBG0�̷�׸����u��         */
#define SCL_RBG1_K 		4   /* RBG1�̌W��ð��ق��u��     */
 ...
 *          �����ɂ����}�N���́A���W�X�^�o�b�t�@�Ɋe�R���g���[���l��
 *          �������݁A�������񂾃��W�X�^�o�b�t�@�̃_�[�e�B�[�t���O��
 *          1 �ɂ����B
-------------------------------------------------------------------------*/
...
/* VDP-II manual p.129 */
#define SCL_SET_SPCCCS(/* 2 bits */ spcccs) /* �X�v���C�g�F���Z���� */\
...
#define SCL_SET_SPCCN(/* 3 bits */ spccn) /* �X�v���C�g�F���Z�����i���o */\
  (SclPriBuffDirty.SclOtherPri = 1,\
   SclOtherPri.SpriteControl \
...
#define SCL_SET_SPCLMD(/* 1 bit */ spclmd) /* �X�v���C�g�̐F�`�� */\
  (SclPriBuffDirty.SclOtherPri = 1,\
   SclOtherPri.SpriteControl \
...
#define SCL_SET_SPWINEN(/* 1 bit */ spwinen) /* �X�v���C�g�E�B���h�E�C�l�[�u�� */\
  (SclPriBuffDirty.SclOtherPri = 1,\
   SclOtherPri.SpriteControl \
...
#define SCL_SET_SPTYPE(/* 4bits */ sptype) /* �X�v���C�g�̃^�C�v�w�� */\
  (SclPriBuffDirty.SclOtherPri = 1,\
   SclOtherPri.SpriteControl \
...
/* VDP-II manual p.131 */
/*-------------------- �X�v���C�g�p�v���C�I���e�B���W�X�^ No.0-7 */
...
/* VDP-II manual p.138 */
/*-- �J���[ RAM �A�h���X�I�t�Z�b�g N0|R1, N1|EXBG, N2, N3, R0, SPRITE */
...
/*----- ���C���J���[���ʃC�l�[�u�� N0|R1, N1|EXBG, N2, N3, R0, SPRITE */
...
/*-------- �����v���C�I���e�B���[�h N0|R1, N1|EXBG, N2, N3, R0 */
...
/*---------�v���C�I���e�B�[�ԍ� N0|R1, N1|EXBG, N2, N3, R0 */
...
#define SCL_SET_BOKEN(/* 1 bits */ boken) /* �{�J�V���Z�C�l�[�u�� */\
  (SclPriBuffDirty.SclOtherPri = 1, \
...
#define SCL_SET_BOKN(/* 3 bits */ bokn) /* �{�J�V���ʔԍ� */\
  (SclPriBuffDirty.SclOtherPri = 1, \
   SclOtherPri.ColorMixControl \
...
#define SCL_SET_EXCCEN(/* 1 bit */ exccn) /* �g���J���[���Z�C�l�[�u�� */\
  (SclPriBuffDirty.SclOtherPri = 1, \
   SclOtherPri.ColorMixControl \
...
#define SCL_SET_CCRTMD(/* 1 bit */ ccrtmd) /* �J���[���Z�������[�h */\
  (SclPriBuffDirty.SclOtherPri = 1, \
   SclOtherPri.ColorMixControl \
...
#define SCL_SET_CCMD(/* 1 bit */ ccmd) /* �J���[���Z���[�h */\
  (SclPriBuffDirty.SclOtherPri = 1, \
   SclOtherPri.ColorMixControl \
...
/*------ �J���[���Z�C�l�[�u�� N0|R1, N1|EXBG, N2, N3, R0, LC, SPRITE */
...
/*------ �X�N���[���ʗp�J���[���Z���� N0|R1, N1|EXBG, N2, N3, R0, LC, BACK */
...
/*-- �J���[�I�t�Z�b�g�C�l�[�u�� N0|R1, N1|EXBG, N2, N3, R0, BACK, SPRITE */
...
/*--- �J���[�I�t�Z�b�g���W�X�^�I�� N0|R1, N1|EXBG, N2, N3, R0, BACK, SPRITE */
...
/*----------- �V���h�E�R���g���[�� N0|R1, N1|EXBG, N2, N3, R0, BACK */
...
extern SclOtherPriRegister  SclOtherPri;  /* ���낢�� */

extern SclSpPriNumRegister  SclSpPriNum;  /* �X�v���C�g�̃v���C�I���e�B�ԍ� */

extern SclBgPriNumRegister  SclBgPriNum;  /* �X�N���[���̃v���C�I���e�B�ԍ� */

extern SclSpColMixRegister  SclSpColMix;  /* �X�v���C�g�̐F���Z */

extern SclBgColMixRegister  SclBgColMix;  /* �X�N���[���̐F���Z */

extern SclColOffsetRegister SclColOffset; /* �J���[�I�t�Z�b�g */

extern SclPriBuffDirtyFlags SclPriBuffDirty; /* ���W�X�^�o�b�t�@�̃_�[�e�B�[�E�t���O */
