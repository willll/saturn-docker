...
curl -c ./cookie-file1 -s -L "https://drive.google.com/file/d/19nKbK6eFHh1cliyFYsBv-P2IGrWTc0Ci/view?usp=sharing"& \
...
curl -c ./cookie-file1 -s -L "https://drive.google.com/file/d/1Nz-aCEe9U3Rxc9QUn3IA6rMP4GY_EwSZ/view?usp=sharing"& \
curl -Lb ./cookie-file1 "https://drive.google.com/uc?export=download&confirm=`awk '/download/ {print $NF}' \
...
curl -c ./cookie-file1 -s -L "https://drive.google.com/file/d/1wqc7bngPUOv_0hgyuIyCTq8l4jc_azSN/view?usp=sharing"& \
curl -Lb ./cookie-file1 "https://drive.google.com/uc?export=download&confirm=`awk '/download/ {print $NF}' \
