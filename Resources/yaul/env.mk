...
generate-cdb::
	...
	$(ECHO)printf -- "-D__INTELLISENSE__ $(SH_CFLAGS_$1) \
	$(foreach dir,$(SHARED_INCLUDE_DIRS),-I$(abspath $(dir))) \
	--include="$(THIS_ROOT)/lib$(MAIN_TARGET)/intellisense.h" -c $(abspath $(2))\n" >&2
endef
...
generate-cdb::
	...
	$(ECHO)printf -- "$(abspath $(2))\n" >&2
	$(ECHO)printf -- "-D__INTELLISENSE__ $(SH_CXXFLAGS_$1) \
	$(foreach dir,$(SHARED_INCLUDE_DIRS),-I$(abspath $(dir))) \
	--include="$(THIS_ROOT)/lib$(MAIN_TARGET)/intellisense.h" -c $(abspath $(2))\n" >&2
endef
