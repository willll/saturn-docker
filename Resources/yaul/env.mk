...
ifeq ($(strip $(YAUL_SH_TOOLCHAIN)),)
  YAUL_SH_TOOLCHAIN = $(YAUL_INSTALL_ROOT)
endif
ifneq (1,$(words [$(strip $(YAUL_SH_TOOLCHAIN))]))
	$(error YAUL_SH_TOOLCHAIN (install root directory) contains spaces)
endif
ifneq ($(shell test -e "$(YAUL_SH_TOOLCHAIN)"; printf "$${?}"),0)
  $(error Path YAUL_SH_TOOLCHAIN (install root directory) does not exist)
endif
ifneq ($(shell test -d "$(YAUL_SH_TOOLCHAIN)" && printf "$${?}"),0)
  $(error Path YAUL_SH_TOOLCHAIN (install root directory) is not a directory)
endif

ifeq ($(strip $(YAUL_68K_TOOLCHAIN)),)
  YAUL_68K_TOOLCHAIN = $(YAUL_INSTALL_ROOT)
endif
ifneq (1,$(words [$(strip $(YAUL_68K_TOOLCHAIN))]))
	$(error YAUL_68K_TOOLCHAIN (install root directory) contains spaces)
endif
ifneq ($(shell test -e "$(YAUL_68K_TOOLCHAIN)"; printf "$${?}"),0)
  $(error Path YAUL_68K_TOOLCHAIN (install root directory) does not exist)
endif
ifneq ($(shell test -d "$(YAUL_68K_TOOLCHAIN)" && printf "$${?}"),0)
  $(error Path YAUL_68K_TOOLCHAIN (install root directory) is not a directory)
endif
...
SH_AR:=      $(YAUL_SH_TOOLCHAIN)/bin/$(YAUL_PROG_SH_PREFIX)-ar$(EXE_EXT)
...
SH_NM:=      $(YAUL_SH_TOOLCHAIN)/bin/$(YAUL_PROG_SH_PREFIX)-nm$(EXE_EXT)
...
M68K_AR:=      $(YAUL_68K_TOOLCHAIN)/bin/$(YAUL_ARCH_M68K_PREFIX)-ar$(EXE_EXT)
...
M68K_NM:=      $(YAUL_68K_TOOLCHAIN)/bin/$(YAUL_ARCH_M68K_PREFIX)-nm$(EXE_EXT)
